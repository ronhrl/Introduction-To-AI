...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        self.goal = tuple()
        self.currentPosition = self.startingPosition, self.corners
        self.corners_list = list(((1, 1), (1, top), (right, 1), (right, top)))
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        """The goal is achieved when the pacman eats all the corners. there for i don't care where the pacman is now."""
